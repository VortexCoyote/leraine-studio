...
public:
    ...
    struct HeaderData {
        ...
        struct EType {
            ...
            EType(HeaderType _headerType,int _numEnumElements, TextFromEnumDelegate  _textFromEnumFunctionPointer, void* _textFromEnumFunctionPointerUserData=NULL,int _numArrayElements=1)
            ...
            EType(HeaderType _headerType,int _numArrayElements=1,bool _needsRadiansToDegs=false)
...
public:
    ...
    public:
        ...
        Header(const char* _name,const char* _tooltip,const HeaderData::EType& _type,const int _precision=-1,const float _startColumnWidth=-1,const char* _prefix="",const char* _suffix="",const HeaderData::Sorting& _sorting = HeaderData::Sorting(),const HeaderData::Editing& _editing =  HeaderData::Editing())  {
        ...
        Header(const char* _name,const char* _tooltip,const HeaderType _type,const int _precision,const float _startColumnWidth,const char* _prefix="",const char* _suffix="",const HeaderData::Sorting& _sorting = HeaderData::Sorting(),const HeaderData::Editing& _editing =  HeaderData::Editing())  {
            init(_name,_tooltip,HeaderData::EType(_type),_precision,_startColumnWidth,_prefix,_suffix,_sorting,_editing);
        }
        Header(const char* _name,const char* _tooltip,const HeaderData::EType& _type,const int _precision,const float _startColumnWidth,const char* _prefix,const char* _suffix,const bool _sorting,const HeaderData::Editing& _editing =  HeaderData::Editing())  {
        ...
        Header(const char* _name,const char* _tooltip,const HeaderType _type,const int _precision,const float _startColumnWidth,const char* _prefix,const char* _suffix,const bool _sorting,const HeaderData::Editing& _editing =  HeaderData::Editing())  {
            init(_name,_tooltip,HeaderData::EType(_type),_precision,_startColumnWidth,_prefix,_suffix,HeaderData::Sorting(_sorting),_editing);
        }

    protected:
        void init(const char* _name,const char* _tooltip,const HeaderData::EType& _type,const int _precision=-1,const float _startColumnWidth=-1,const char* _prefix="",const char* _suffix="",const HeaderData::Sorting& _sorting = HeaderData::Sorting(),const HeaderData::Editing& _editing =  HeaderData::Editing())
        {
...
typedef ListViewBase::HeaderData::EType ListViewHeaderType;
